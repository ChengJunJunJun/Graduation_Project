...
import numpy as np
from models.rcnn import RCNNnet as RCNNnet
...
for epoch in range(200):
    ...
    for i in range(800):
        ...
        Y_tensor = torch.Tensor(Y).to(device).permute(0,2,1)
...
torch.save(model.state_dict(), 'checkpoints/RCNN_0.001.pth')